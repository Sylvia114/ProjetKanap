...
let checkFirstName = function(firstNameFunction){
    let RegExpFirstName = new RegExp("^[a-zA-Z -]{2,}$", "g");

    if (RegExpFirstName.test(firstNameFunction.value)){
...
let checkLastName = function(lastNameFunction){
    let RegExpLastName = new RegExp("^[a-zA-Z -]{2,}$", "g");

    if (RegExpLastName.test(lastNameFunction.value)){
...
let checkAddress = function(addressFunction){
    let RegExpAddress = new RegExp("^[a-zA-Z0-9 -]+$", "g");

    if (RegExpAddress.test(addressFunction.value)){
...
let checkCity = function(cityFunction){
    let RegExpCity = new RegExp("^[0-9a-zA-Z -]+$", "g");

    if (RegExpCity.test(cityFunction.value)){
...
let checkEmail = function(emailFunction){
    let RegExpEmail = new RegExp ("^[a-zA-Z0-9.-_]+[@]{1}[a-zA-Z0-9.-_]+[.]{1}[a-z]{2,10}$", "g");
 
    if (RegExpEmail.test(emailFunction.value)){
